...
class TestShellSession:
    ...
    def test_shell_variable_persistence(self):
    ...
    def test_no_newline_output(self):
...
class TestShellTool:
    ...
    def test_tool_basic_usage(self):
        """Test basic tool usage."""
        context = self.create_mock_context()
        output = shell_tool("echo test", tool_context=context)
        assert "test" in output

    def test_tool_creates_session(self):
        """Test that tool creates session on agent."""
        context = self.create_mock_context()
        shell_tool("echo test", tool_context=context)
        assert hasattr(context.agent, '_shell_tool_session')

    def test_tool_reuses_session(self):
    ...
    def test_tool_restart_flag(self):
    ...
    def test_tool_restart_only(self):
    ...
    def test_tool_session_cleanup_on_error(self):
        """Test that session is recreated after fatal error."""
        context = self.create_mock_context()

        # First call succeeds
        shell_tool("echo first", tool_context=context)
        session = getattr(context.agent, '_shell_tool_session')
...
class TestArchitecturalProperties:
    ...
    def test_no_readline_dependency(self):
    ...
    def test_binary_mode_handling(self):
    ...
    def test_buffer_offset_isolation(self):
    ...
    def test_merged_stderr_stdout(self):
