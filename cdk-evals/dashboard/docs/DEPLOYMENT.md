...
### What I did:
```bash
─afarn at 80a9972d0005 in /Volumes/workplace/strandsorg/evals/eval-dashboard on deploy✘✘✘
╰─± ./infrastructure/setup.sh
=== Strands Evals Dashboard Infrastructure Setup ===

AWS Account ID: <ACCOUNT_ID>

Step 1: Creating S3 bucket...
Created bucket: strands-evals-dashboard
Bucket tagged with Project=strands-evals-dashboard

Step 2: Blocking public access...
Public access blocked

Step 3: Creating Origin Access Control...
Created OAC with ID: E3IWHZ3MB8YG8R

Step 4: Creating CloudFront distribution...
Created CloudFront distribution:
  ID: E1C2TAZPKUUVMM
  Domain: d1cxvsanhrqxxx.cloudfront.net

Tagging CloudFront distribution...
CloudFront distribution tagged with Project=strands-evals-dashboard

Step 5: Applying S3 bucket policy...
...
CloudFront URL: https://d1cxvsanhrqxxx.cloudfront.net

Note: CloudFront distribution may take 5-10 minutes to deploy.
Run './deploy.sh' to build and deploy the application.
```
...
URL: https://d1cxvsanhrqxxx.cloudfront.net

Note: Cache invalidation may take 1-2 minutes to propagate.
```
